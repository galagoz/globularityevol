...
pdf("/data/workspaces/lag/workspaces/lg-ukbiobank/projects/globularity/evolution/results/phylogenetic_context/multiple_seq_alignments/10bp/rs755576_10bp_tree.pdf")
plot(x); foo()
dev.off()
