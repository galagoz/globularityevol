...
```{r}
library(ape)
x <- read.tree(text = read.table("/data/workspaces/lag/workspaces/lg-ukbiobank/projects/globularity/evolution/results/phylogenetic_context/multiple_seq_alignments/10bp/rs755576_10bp_tree.txt")[1,1])
...
op <- par(mar = c(18,4,4,2) + 0.1)
plot(x, yaxt = "n")
par(op) ## reset
pdf("/data/workspaces/lag/workspaces/lg-ukbiobank/projects/globularity/evolution/results/phylogenetic_context/multiple_seq_alignments/10bp/rs755576_10bp_tree.pdf", width = 5, height = 15)
plot(x, yaxt = "n")
dev.off()

y <- read.dendrogram(text = read.table("/data/workspaces/lag/workspaces/lg-ukbiobank/projects/globularity/evolution/results/phylogenetic_context/multiple_seq_alignments/10bp/rs10841789_10bp_tree.txt", header = T)[1,1])
p1 = plot(y, yaxt = "n")
