...
--overlap-annot \
--ref-ld-chr /data/clusterfs/lag/users/gokala/globularity-evol/resources/annotations/${fannot}/${annot}.,/data/clusterfs/lag/users/gokala/globularity-evol/resources/baselineLD/baselineLD.  \
